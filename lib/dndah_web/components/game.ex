defmodule DndahWeb.GameComponents do
  use Phoenix.Component

  import DndahWeb.CoreComponents

  # alias Phoenix.LiveView.JS
  # import DndahWeb.Gettext
  ...
  defp item_base(%Dndah.Game.ItemBase{} = base), do: base
  defp item_base(%Dndah.Inventory.UserGameItem{item_base: base}), do: base
  ...
  defp item_properties(assigns) do
    assigns =
      assign_new(assigns, :by_mod, fn ->
        Dndah.Game.ItemBase.sort_properties(assigns.properties)
      end)

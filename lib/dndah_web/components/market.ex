defmodule DndahWeb.MarketComponents do
  ...
  defp relative_ts(dt) do
    ...
    |> Dndah.Cldr.DateTime.Relative.to_string!()
  end

  defdelegate humanize_offer_status(status), to: Dndah.Market.ListingOffer, as: :humanize_status
end

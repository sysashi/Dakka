defmodule DndahWeb.InventoryLive do
  ...
  alias Dndah.Inventory.Events.UserItemCreated
  ...
  def render(assigns) do
    ...
    <div class="mb-4 border-b border-zinc-700 pb-4">
      ...
      <.live_component
        module={DndahWeb.Inventory.AddItemLive}
        id="add-item"
    ...
    >
      <.live_component
        current_user={@current_user}
        module={DndahWeb.ListingFormComponent}
        id={@listing.id || :new}
        title={@page_title}
        action={@live_action}
        listing={@listing}

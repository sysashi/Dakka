defmodule DndahWeb.MarketLive.ListingFiltersFormComponent do
  use DndahWeb, :live_component

  import DndahWeb.GameComponents

  alias Dndah.ItemFilters
      ...
      <.form for={@form} phx-change="validate-item-filters" phx-target={@myself} phx-submit="search">
        <article class="grid grid-cols-3 gap-4 p-4">
          <section class="col-span-full flex gap-4 border-b border-zinc-600 pb-4 items-baseline">
            ...
            <div class="flex-1">
              <.checkgroup
                options={Dndah.Game.rarity_options()}
                field={@form[:rarities]}
                label="Rarity"
              />
            </div>
  ...
  defp item_base_filters(assigns) do
    ...
    <.live_component
      ...
      class="text-md"
      field="item_base"
      module={DndahWeb.DropdownSearchComponent}
      search_fun={&Dndah.Game.search_item_base/1}
  ...
  defp mod_filters(assigns) do
    ...
    <div class="mt-2">
      <.live_component
        ...
        class="text-md"
        module={DndahWeb.DropdownSearchComponent}
        search_fun={&Dndah.Game.search_item_mod/1}
  ...
  defp property_filters(assigns) do
    ...
    <div class="mt-2">
      <.live_component
        ...
        class="text-md"
        module={DndahWeb.DropdownSearchComponent}
        search_fun={&Dndah.Game.search_item_mod(&1, value_types: :predefined_value)}
        placeholder="Enter mod name..."

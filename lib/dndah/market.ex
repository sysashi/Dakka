defmodule Dndah.Market do
  ...
  def subscribe(topic \\ :market) do
    Phoenix.PubSub.subscribe(Dndah.PubSub, topic(topic))
  end
  ...
  def item_base_props_filter(query, filters) do
    props_query =
      from(Dndah.Game.ItemBaseMod, as: :item_base_mod)
  ...
  defp item_mods_filters(query, filters) do
    mods_query =
      from(um in Dndah.Inventory.UserGameItemMod, as: :user_mod)
